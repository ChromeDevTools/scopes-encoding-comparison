...
export const CODEC: Codec = {
  ...
  description:
    "Input source map without any sources, scope information. Mappings are stripped of names.",
  encode: (info: ScopeInfo, initialMap: SourceMapJson) =>
    stripSources(info, stripNames(info, initialMap)),
  decode: () => {
    throw new Error(
